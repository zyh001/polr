    ...
    <div class='row' id='options' ng-cloak>
        ...
        <div class='btn-group btn-toggle visibility-toggler' data-toggle='buttons'>
            ...
            <label class='btn btn-sm btn-default'>
                <input type='radio' name='options' value='s' /> 私有
            </label>
        </div>
        @endif
        ...
        <div>
            ...
            <div>
                <a href='#' class='btn btn-success btn-xs check-btn' id='check-link-availability'>可用性检测</a>
                <div id='link-availability-status'></div>
            </div>
        </div>
    </div>
    <input type='submit' class='btn btn-info' id='shorten' value='缩短' />
